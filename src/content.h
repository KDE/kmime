...
public:
    ...
    */
    ...
    // clang-format on
    [[deprecated("use decodedText(DecodedTextTrimOption) instead")]]
    inline QString decodedText(bool trimText, bool removeTrailingNewlines = false) const
    {

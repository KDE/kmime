...
public:
  ...
  */
  ...
  /*!
    ...
    \a head is a QByteArray containing the header data.
  ...
  */
  ...
  /*!
    ...
    \a body is a QByteArray containing the body data.

    Note \a body is assumed to be decoded as far as the content transfer encoding
    is concerned.
  ...
  */
  ...
  /*!
    ...
    Note \a body is assumed to be encoded as far as the content transfer encoding
    is concerned.
  ...
  */
  ...
  /*!
    ...
    \a preamble a QByteArray containing what will be used as the
    MIME preamble.
  ...
  */
  ...
  /*!
    ...
    \a trimOption Control how to trim trailing white spaces.
  ...
  */
  ...
  /*!
    ...
    \a content The Content to remove. It is not deleted, ownership goes
    back to the caller.
  ...
  */
  ...
  /*!
    Changes the encoding of this Content to \a e.  If the Content is binary,
    this actually re-encodes the data to use the new encoding.

    \a e The new encoding to use.
  */
